...
var tet=[{name:"",m1:Date.parse("Oct 13 2023 00:00:00")}];var tetlength=tet.length;
...
for(var i=0;i<tetlength;i++){
	...
	if(timenow<=m4){
		...
		var theyear=i+2023;var txttet=tet[i].name;
		var txttitle="Cẩm Ly sắp về  "+txttet;
		var txttetornot="CẨM  LY  SẮP  VỀ !! "+txttet;
		var txtdays="Chúc";var txthours="Mừng";var txtmins="Trở";var txtsecs="Lại";
